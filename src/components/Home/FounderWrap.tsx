    ...
    <Box className="home-founder__container" container>
      <Box className="home-founder--wrap p-tb-30 p-lr-20">
        <Row gutter={32} className="home-founder--row">
          <Col xs={24} lg={12}>
            <AntImage
              alt="Avatar Founder CodeMemory - Lê Huy Du (Du Sainbolt)"
              src={staticPath("/images/avatar_home_page.webp")}
            />
          </Col>
          <Col className="home-founder--content" xs={24} lg={12}>
            ...
            <Typography.Paragraph className="home-founder--name">
              {t("home.txt_name_founder")}
            </Typography.Paragraph>
            <Typography.Text className="home-founder--mission">
              {t("home.txt_mission_founder")}
            </Typography.Text>
            <Divider />
            <Typography.Paragraph className="txt-dec-light-1 italic mb-16">
            ...
            <AntImage
              alt="Chữ ký của founder"
              src={staticPath("/images/dusainbolt-autograph.png")}
            />
          </Col>
        </Row>
      </Box>
