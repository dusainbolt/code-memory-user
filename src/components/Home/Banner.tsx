    ...
    <Box container className="home-banner mt-30">
      <Row gutter={30}>
        <Col
          xs={{ span: 24, order: 2 }}
          lg={{ span: 10, order: 1 }}
          className="home-banner--wrap-info"
        >
          <Space direction="vertical">
            <Typography.Title className="home-banner--title">
              {DEFAULT_SEO.appName}
            </Typography.Title>
            <Typography.Paragraph className="home-banner--description txt-dec-1 mt-20">
              {t("home.txt_description_banner_1")}
              <Typography.Text className="high-light">
          ...
          <Typography.Link
            className="home-banner--button-link"
            href="#interact"
          >
            <ButtonCommon
              type="primary"
              shape="round"
              fontAWS={faAngleDoubleDown}
              className="home-banner--button-next-view"
            >
        ...
        <Col xs={{ span: 24, order: 1 }} lg={{ span: 14, order: 2 }}>
          <AntImage
            alt="Ảnh banner của CodeMemory"
            className="home-banner--img-content"
            src={staticPath("/images/img_banner.webp")}
          />
        </Col>
      </Row>
    </Box>
