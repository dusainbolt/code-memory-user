...
const ThirdWrap: React.FC<_ThirdWrap> = ({}) => {
    ...
    return (
        <Box className="third-wrap--container" container>
            <Row className="third-wrap--card-wrap">
                <Col md={12} xxl={4}>
                    <Box className="third-wrap--card-item" fadeLeftComponent>
                        <ImageWrapper
                            {...sizeImageService}
                            centerImg
                        ...
                        />
                        <Typography textCenter fontWeight="bold" type="h3" lineHeight={37.5} className="third-wrap--card-title-service">
                            Chia sẻ
                        </Typography>
                        <Typography textCenter fontWeight="regular" type="p" lineHeight={30} className="third-wrap--card-description-service">
                            We all love to share our wins. It;s a lot harder to share our failures. Behind every success there are often a lot{' '}
                        </Typography>
                    </Box>
                </Col>
                <Col md={12} xxl={4}>
                    <Box className="third-wrap--card-item active" fadeInComponent>
                ...
                <Col md={12} xxl={4}>
                    <Box className="third-wrap--card-item" fadeRightComponent>
