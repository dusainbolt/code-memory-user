            ...
            <Row className="third-wrap__card-wrap">
                <Col md={12} xxl={4}>
                    <Box className="third-wrap__card-item">
                        ...
                        <Typography center weight={700} type="h3" lineHeight={37.5} className="third-wrap__card-title-service">
                            Product Design
                        </Typography>
                        <Typography center weight={400} type="p" lineHeight={30} className="third-wrap__card-description-service">
