...
const FourthWrap: React.FC<_FourthWrap> = ({}) => {
    return (
        <Row className="fourth-wrap" container>
            <Col md={12} xxl={5}>
                <Typography fontWeight={700} lineHeight={30} type="h2" className="fourth-wrap__title-small">
                    About Us
                </Typography>
                <Typography fontWeight={700} lineHeight={54} type="h3" className="fourth-wrap__title-large">
                    We Lead From The Front
                </Typography>
                <Typography fontWeight={400} lineHeight={30} className="mt-36 mb-36">
                ...
                <Typography fontWeight={400} lineHeight={30}>
                ...
                <Box flexBox mt={60} justify="start">
                    <Button mr={39} round width={206} height={60} label="Learn more" />
                    <ButtonIcon hoverIcon spaceLabel={15} icon={faBars} fontSize={20} sizeIcon={60} label={"Watch Video"}/>
                </Box>
            </Col>
            <Col md={12} xxl={7}>
