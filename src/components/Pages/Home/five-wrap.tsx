...
const FiveWrap: React.FC<_FiveWrap> = ({}) => {
    return (
        <Row className="service-wrap" mb={100} container>
            ...
            <Col md={12} xxl={6} fadeRightComponent>
                <Box flexBox minHeightPercent={90} flexCol alignItem="start">
                    <Typography fontWeight="bold" lineHeight={30} type="h2" className="service-wrap--title-small">
                        About Us
                    </Typography>
                    <Typography fontWeight="bold" lineHeight={54} type="h3" className="service-wrap--title-large">
