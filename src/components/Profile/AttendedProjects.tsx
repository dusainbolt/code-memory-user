...
export const AttendedProjects: FC<any> = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      listDec: [`Mô tả: Dịch vụ tìm kiếm các của hàng trên NFTify Platform và đánh giá chúng`, `Công nghệ: NextJS, TypeScript, Web3, Ant Design`],
    },
    {
      timeEnd: 'Tháng 5, 2021',
    ...
    },
    {
      ...
      listDec: [`Mô tả: Xây dựng hệ thóng phát live streaming  ở phía client sử dụng WebRTC`, `Công nghệ: ReactJS, Socket.io, Ant Design, WebRTC`],
    },
    {
