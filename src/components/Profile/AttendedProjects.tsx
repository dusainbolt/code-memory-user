  ...
  const data = [
    {
      ...
      titleProject:
        "NFTify Bridge: Hệ thống giao dịch tiền ảo qua Smart Contract",
      listDec: [
    ...
    },
    {
      ...
      listDec: [
        `Mô tả: Xây dựng ứng dụng quản lí và xác minh customer`,
        `Công nghệ: ReactJS, Meterial UI, ChartJS, Socket.io`,
      ],
    },
    {
    ...
    },
    {
      ...
      listDec: [
        `Mô tả: Migrate ứng dụng quản lý doanh nghiệp từ source code Adobe Flex sang AngularJS`,
        `Công nghệ: AngularJS, AgGrid`,
      ],
    },
    {
    ...
    },
    {
      ...
      listDec: [
        `Mô tả: Nền tảng quản trị, liệt kê danh sách và vẽ chart theo dõi tiền ảo.`,
        `Công nghệ: ReactJS, ChartingView, Ant Design`,
      ],
    },
    {
    ...
    },
    {
      ...
      listDec: [
        `Mô tả: Maintain trang quản trị cho hệ thống giao dịch tiền ảo`,
        `Công nghệ: VueJS`,
      ],
    },
    {
