      ...
      <Row gutter={[24, 32]}>
          ...
          <Zoom>
            <Box className="profile__info-circle flx-center align-left">
              <Box className="profile__avatar-content mr-12">
                <AntImage src={staticPath('/images/profile/ha_son_hai_van.png')} alt="Ảnh trường đại học của Lê Huy Du" />
              </Box>
        ...
        <Col xs={24} md={12}>
          <Zoom>
            <Box className="profile__info-circle flx-center align-left">
              <Box className="profile__avatar-content mr-12">
                <AntImage src={staticPath('/images/profile/ekoios.png')} alt="Ảnh trường đại học của Lê Huy Du" />
              </Box>
              <Box className="profile__info-text-time flx-center">
                <Typography.Title className="profile__info-text" level={4}>
