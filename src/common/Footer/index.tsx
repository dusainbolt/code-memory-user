...
const Footer: FC<IFooter> = ({ seoHome }) => {
  ...
  const LIST_CONTACT = [
    {
      ...
      title: t("common.txt_tooltip_contact", {
        contact: t("footer.txt_gmail"),
      }),
    },
    {
      icon: faAddressBook,
    ...
    },
    {
      ...
      title: t("common.txt_tooltip_contact", {
        contact: t("footer.txt_phone_number"),
      }),
    },
  ];
  ...
  return (
    <footer className="app-footer">
      ...
      <Box container>
        <Row gutter={32}>
          <Col xs={24} lg={8} xl={6} className="app-footer__logo-col">
            ...
            <Typography.Paragraph className="app-footer--description-logo">
              {t("footer.txt_description_logo")}
          ...
          <Col xs={24} sm={8} lg={8} xl={4}>
            ...
            {LIST_MENU.map(
              (item, index) =>
                index > 0 && (
                  <Typography.Link
                    title={t("common.txt_tooltip_access", {
                      access: t(`menu.${item.name}`),
                    })}
          ...
          <Col
            ...
            lg={8}
            xl={6}
            className="app-footer--col-contact"
          >
            <Typography.Title className="title-2 mb-10" level={4}>
      ...
      <Box className="p-10 pb-24 mt-34 txt-center">
