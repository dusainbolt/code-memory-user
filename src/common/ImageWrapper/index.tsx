...
const ImageWrapper: React.FC<_ImageWrapper> = ({ src, onlyImage = false, width, height, className, quality = 85, alt, centerImg, children, boxProps = {} }) => {
    ...
    const image = <Image width={width} height={height} alt={alt} quality={quality} src={src} />;
