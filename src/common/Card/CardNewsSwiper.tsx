...
const SwiperSlideNewsItem: React.FC<any> = ({ children, className, slidesPerView, ...props }) => {
  ...
  const swiperCommon = (
    <SwiperSlide className="home-news--item">
      <AntImage alt="thumbnail-new" src="https://appdu-storage.s3-ap-southeast-1.amazonaws.com/118005360_928999227584443_8060562362571425079_o.png" />
      <Box className="p-tb-12 p-lr-22">
        ...
        <Typography.Paragraph ellipsis={{ rows: 3 }} className="txt-dec-light">
          Zero To Mastery's Lead Designer, Laura, discusses her key takeaways for Designers from Figma's recent virtual conference - Config 2021.
